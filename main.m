...
% Information and Codification Theory
...
% Para una senal Senoidal de voz
...
num_periodos=1;         % Periodo de la señal de informacion
...
t = 0:ts:d*6; %Vector de Tiempo
F = A*cos(2*pi*fm.*t)

ppm=10; %Muestra por cada simbolo binario
